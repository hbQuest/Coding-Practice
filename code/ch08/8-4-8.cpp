...
PhanSo thuong2PhanSo(PhanSo ps1, PhanSo ps2) {
    PhanSo ps3;
...
HonSo thuong2HonSo(HonSo hs1, HonSo hs2) {
    PhanSo ps1 = honSoSangPhanSo(hs1);
    PhanSo ps2 = honSoSangPhanSo(hs2);
    ps1 = thuong2PhanSo(ps1, ps2);
...
int main() {
    ...
    HonSo hs3 = thuong2HonSo(hs1, hs2);
    printf("Thuong 2 hon so la: ");
    xuatHonSo(hs3);
    return 0;
}