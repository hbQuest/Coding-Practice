...
void sapXepDongChiSoChanTangDanLeGiamDan(int a[][MAX],int dong,int cot) {
    for (int i = 0; i < dong; i++) {
...
int main() {
    ...
    printf("Ma tran sau sap xep dong co so chan tang dan va so le giam dan:\n");
    sapXepDongChiSoChanTangDanLeGiamDan(a,dong,cot);
    xuat(a,dong,cot);
    return 0;
}